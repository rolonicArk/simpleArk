...
(defn build-demo
  ...
  (-> actions
      ...
      (builder/build-relation :rel/watches :local/profile-capability :profile :local/Sam-profile :profile)
      ...
      (builder/build-relation :rel/watches :local/profile-capability :profile :local/Kris-profile :profile)
      ))
