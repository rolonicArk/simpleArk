...
(defn build-demo
  ...
  (-> actions
      ...
      (builder/build-relation :rel/watches :welcome :local/welcome-capability :local/Fred-welcome true)
      ...
      (builder/build-relation :rel/watches :welcome :local/welcome-capability :local/Sam-welcome true)
      ...
      (builder/build-relation :rel/watches :welcome :local/welcome-capability :local/Kris-welcome true)
