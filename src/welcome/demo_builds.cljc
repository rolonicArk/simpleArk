...
(defn build-user-capability
  ...
  (let [user-capability-kw (keyword "local" (str user "-" capability))
    ...
    (-> actions
        ...
        (builder/build-relation :rel/capability user-capability-kw user-kw capability-kw user-kw)
        (builder/build-relation :rel/user user-capability-kw capability-kw user-kw capability-kw)
        )))
...
(defn build-demo
  ...
  (-> actions
      ...
      (builder/build-relation :rel/watches :local/welcome-capability :Fred :local/Fred-welcome :welcome)
      ...
      (builder/build-relation :rel/watches :local/welcome-capability :Sam :local/Sam-welcome :welcome)
      ...
      (builder/build-relation :rel/watches :local/welcome-capability :Kris :local/Kris-welcome :welcome)
