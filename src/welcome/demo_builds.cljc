...
(defn build-user-capability
  ...
  (let [user-capability-kw (keyword "local" (str user "-" capability))
    ...
    (-> actions
        ...
        (builder/build-relation :rel/capability user-kw user-capability-kw capability-kw)
        (builder/build-relation :rel/user capability-kw user-capability-kw user-kw)
        )))
