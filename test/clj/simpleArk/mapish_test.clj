...
(deftest mapish
  ...
  (println (mapish/mi-seq (mapish/mi-sub mi0 >= :a)))
  (println (mapish/mi-seq (mapish/mi-sub mi0 > :a)))
  (println (mapish/mi-seq (mapish/mi-sub mi0 >= :b)))
  (println (mapish/mi-seq (mapish/mi-sub mi0 > :b)))
  (println (mapish/mi-seq (mapish/mi-sub mi1 >= :a)))
  (println (mapish/mi-seq (mapish/mi-sub mi1 > :a)))
  (println (mapish/mi-seq (mapish/mi-sub mi1 >= :b)))
  (println (mapish/mi-seq (mapish/mi-sub mi1 > :b)))
  (println (mapish/mi-seq (mapish/mi-sub mi2 >= :a)))
  (println (mapish/mi-seq (mapish/mi-sub mi2 > :a)))
  (println (mapish/mi-seq (mapish/mi-sub mi2 >= :b)))
  (println (mapish/mi-seq (mapish/mi-sub mi2 > :b)))
  (println (mapish/mi-seq (mapish/mi-sub mi0 >= :a <= :f)))
  (println (mapish/mi-seq (mapish/mi-sub mi0 > :a < :f)))
  (println (mapish/mi-seq (mapish/mi-sub mi0 >= :b <= :e)))
  (println (mapish/mi-seq (mapish/mi-sub mi0 > :b < :e)))
  (println (mapish/mi-seq (mapish/mi-sub mi1 >= :a <= :f)))
  (println (mapish/mi-seq (mapish/mi-sub mi1 > :a < :f)))
  (println (mapish/mi-seq (mapish/mi-sub mi1 >= :b <= :e)))
  (println (mapish/mi-seq (mapish/mi-sub mi1 > :b < :e)))
  (println (mapish/mi-seq (mapish/mi-sub mi2 >= :a <= :f)))
  (println (mapish/mi-seq (mapish/mi-sub mi2 > :a < :f)))
  (println (mapish/mi-seq (mapish/mi-sub mi2 >= :b <= :e)))
  (println (mapish/mi-seq (mapish/mi-sub mi2 > :b < :e)))
  )
