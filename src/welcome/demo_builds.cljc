...
(defn build-demo
  ...
  (-> actions
      ...
      (builder/build-relation :rel/watches :local/profile-capability :local/Fred-profile :profile)
      ...
      (builder/build-relation :rel/watches :local/profile-capability :local/Sam-profile :profile)
      ...
      (builder/build-relation :rel/watches :local/profile-capability :local/Kris-profile :profile)
      ))
